...
def detect():    
        ...
        detector.setModelPath(r"D:\aiml\backend\modelfiles\detection_model-ex-006--loss-0009.732.h5") 
        detector.setJsonPath(r"D:\aiml\backend\modelfiles\detection_config.json")
        detector.loadModel()
        count=0
        detections = detector.detectObjectsFromImage(input_image=r"D:\aiml\backend\pic\input.png", output_image_path=r"D:\aiml\backend\pic\output.png")
        ...
        for eachObject in detections:
            for i in range(i,25):
                ...
                count=0
        wb.save("D:\\aiml\\backend\\xlsx\\co.xlsx")
...
class Xpath_Util:
	...
	def generate_xpath(self,soup):
                    ...
                    wb.save("D:\\aiml\\backend\\xlsx\\xpath.xlsx")
                    return result_flag
...
if __name__ == "__main__":
	...
	driver = webdriver.Chrome(r"D:\aiml\backend\driver\chromedriver.exe")
...
def merger():
    ...
    btn=['button_sign_in','sign_in','button_signin','input_signinsubmit','button_sign_in','input_submit_sign_in','button_login']
    
    workbook1 = load_workbook(filename=r"D:\aiml\backend\xlsx\co.xlsx")
    ...
    workbook = load_workbook(filename=r"D:\aiml\backend\xlsx\xpath.xlsx")
    ...
    workbook1.save("D:\\aiml\\variables\\co.xlsx")
merger()
