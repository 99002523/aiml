...
def detect():    
        ...
        detector.setModelPath(r"D:\backend\modelfiles\detection_model-ex-006--loss-0009.732.h5") 
        detector.setJsonPath(r"D:\backend\modelfiles\detection_config.json")
        detector.loadModel()
        count=0
        detections = detector.detectObjectsFromImage(input_image=r"D:\backend\pic\github.png", output_image_path=r"D:\backend\pic\output.png")
        ...
        for eachObject in detections:
            for i in range(i,25):
                ...
                count=0
        wb.save("D:\\backend\\xlsx\\coordinates.xlsx")
